...
const chocController = require('./app/controllers/ChocController');
...
routes.put('/users/:id', validatorMid.userUpdateValidator, userController.update); // Altera os dados solicitados na requisição (exceto a senha, fazer endpoint e regras de negócio diferenciadas para "esqueci minha senha" e somente para "alteração de senha");
routes.delete('/users/:id', userController.destroy); // Importa do controller as funções da classe e os verbos HTTP


routes.post('/chocolates', chocController.store); // Importa do controller as funções da classe e os verbos HTTP e os middlewares
routes.get('/chocolates', chocController.index); // Importa do controller as funções da classe e os verbos HTTP
routes.get('/chocolates/:id', chocController.show); // Importa do controller as funções da classe e os verbos HTTP
routes.put('/chocolates/:id', chocController.update); // Altera os dados solicitados na requisição (exceto a senha, fazer endpoint e regras de negócio diferenciadas para "esqueci minha senha" e somente para "alteração de senha");
routes.delete('/chocolates/:id', chocController.destroy); // Importa do controller as funções da classe e os verbos HTTP
